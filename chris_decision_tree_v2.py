...
tree_clf_d2.fit(X_train, y_train)
...
tree_clf_d4.fit(X_train, y_train)

export_graphviz(
        tree_clf_d2,
        out_file=image_path("noshow_tree_d2_v2.dot"),
...
export_graphviz(
        tree_clf_d3,
        out_file=image_path("noshow_tree_d3_v2.dot"),
        feature_names=list(X_train),
        class_names=y,
        rounded=True,
        filled=True
...
export_graphviz(
        tree_clf_d4,
        out_file=image_path("noshow_tree_d4_v2.dot"),
        feature_names=list(X_train),
        class_names=y,
        rounded=True,
        filled=True
...
y_pred_d3 = tree_clf_d3.predict(X_test)
y_pred_d4 = tree_clf_d4.predict(X_test)

	
print ("Accuracy for d2 tree is ", accuracy_score(y_test,y_pred_d2)*100)
print ("Accuracy for d3 tree is ", accuracy_score(y_test,y_pred_d3)*100)
print ("Accuracy for d4 tree is ", accuracy_score(y_test,y_pred_d4)*100)